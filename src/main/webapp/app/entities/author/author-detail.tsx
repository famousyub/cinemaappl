    ...
    <Row>
      <Col md="8">
        <h2 data-cy="authorDetailsHeading">
          <Translate contentKey="myappApp.author.detail.title">Author</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="nameauthor">
              <Translate contentKey="myappApp.author.nameauthor">Nameauthor</Translate>
            </span>
          </dt>
          <dd>{authorEntity.nameauthor}</dd>
          <dt>
            <span id="birthDate">
          ...
          <dt>
            <span id="description">
              <Translate contentKey="myappApp.author.description">Description</Translate>
            </span>
          </dt>
